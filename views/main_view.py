...
class HelpDeskView(ctk.CTk):
    def __init__(self):
        ...
        self.title("Controllo Stampanti - Help Desk per Assistenza Tecnica")
        ...
        self.lbl_firma = ctk.CTkLabel(
            self, 
            text="Developed by GdV Valenza srl - V.0.4.1 latest", 
        ...
        # Modificato per mostrare subito "Gestione Stampante"
        self.tabview.set("Gestione Stampante")
    ...
    def imposta_controller(self, controller):
        ...
        # 1. Collegamenti del Main Controller
        ...
        # Forza il controllo automatico iniziale se la tab attiva è Gestione Stampante
